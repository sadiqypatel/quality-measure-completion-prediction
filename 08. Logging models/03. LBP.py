...
experiment_name = "/Workspace/Users/spa240@ccwdata.org/Paper 4/06. Hyperparameters - all features/02. Postpartum/02. final model/LBP - logged model"
...
for params in params_list:
    ...
    with mlflow.start_run():
        ...
        mlflow.spark.log_model(model, artifact_path="prenatal_model_new1.tar.gz")
...
# best_train_predictions.write.saveAsTable("dua_058828_spa240.paper_4_lower_back_final_train_xgboost_new1", mode="overwrite")
# best_test_predictions.write.saveAsTable("dua_058828_spa240.paper_4_lower_back_final_test_xgboost_new1", mode="overwrite")