...
experiment_name = "/Workspace/Users/spa240@ccwdata.org/Paper 4/06. Hyperparameters - all features/09. SPC - statin received/SPC Received Logged"
...
for params in params_list:
    ...
    with mlflow.start_run():
        ...
        mlflow.spark.log_model(model, artifact_path="spc_received.tar.gz")
