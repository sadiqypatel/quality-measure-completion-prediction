...
experiment_name = "/Workspace/Users/spa240@ccwdata.org/Paper 4/06. Hyperparameters - all features/11. SDP - statin received/02. Final Model/SPD received Logged"
...
for params in params_list:
    ...
    with mlflow.start_run():
        ...
        mlflow.spark.log_model(model, artifact_path="spd_received.tar.gz")
