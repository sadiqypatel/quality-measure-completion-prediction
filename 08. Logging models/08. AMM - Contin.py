...
experiment_name = "/Workspace/Users/spa240@ccwdata.org/Paper 4/06. Hyperparameters - all features/07. AMM - Acute Phase/02. final model/AMM Contin - Logged"
...
for params in params_list:
    ...
    with mlflow.start_run():
        ...
        mlflow.spark.log_model(model, artifact_path="amm_contin.tar.gz")
