...
experiment_name = "/Workspace/Users/spa240@ccwdata.org/Paper 4/06. Hyperparameters - all features/02. Postpartum/02. final model/Postpartum - Logged"
...
for params in params_list:
    ...
    with mlflow.start_run():
        ...
        mlflow.spark.log_model(model, artifact_path="postpartum_model_new1.tar.gz")