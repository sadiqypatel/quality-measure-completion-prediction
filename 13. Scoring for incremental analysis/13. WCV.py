...
logged_model = 'runs:/489e7d72430b44f297a812a953774d63/wcv.tar.gz'
...
final_original = final_original.withColumn("outcome", when(final_original.any_visit_2018 == 1, 0).otherwise(1))
#final_original.show()
...
for i in range(1, 13):
    ...
    final_updated = final_updated.withColumn("outcome", when(final_updated.any_visit_2018 == 1, 0).otherwise(1))
