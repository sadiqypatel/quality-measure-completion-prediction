...
logged_model = 'runs:/2a27c098f1694dca9dff695d5f6fd7c9/pbd_model.tar.gz'
...
final_original = final_original.withColumn("outcome", when(final_original.bh_visit == 1, 0).otherwise(1))
#final_original.show()
...
for i in range(1, 13):
    ...
    final_updated = final_updated.withColumn("outcome", when(final_updated.bh_visit == 1, 0).otherwise(1))
