...
logged_model = 'runs:/118653266b9742cca5293db410825742/prenatal_model_new1.tar.gz'
...
final_original = final_original.withColumn("outcome", when(final_original.low_back_pass == 1, 0).otherwise(1))
#final_original.show()
...
for i in range(1, 13):
    ...
    df = spark.table(f"dua_058828_spa240.paper4_original_df_changed_sdoh_vector_{i}_part2")
    ...
    final_updated = final_updated.withColumn("outcome", when(final_updated.low_back_pass == 1, 0).otherwise(1))
