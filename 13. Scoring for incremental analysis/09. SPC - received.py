...
logged_model = 'runs:/21f7fd8402aa4a75bd64d762bebe3f21/spc_received.tar.gz'
...
final_original = final_original.withColumn("outcome", when(final_original.anymed == 1, 0).otherwise(1))
#final_original.show()
...
for i in range(1, 13):
    ...
    final_updated = final_updated.withColumn("outcome", when(final_updated.anymed == 1, 0).otherwise(1))
