...
logged_model = 'runs:/07058fa5927045d0b87938032280c9ed/postpartum_model_new1.tar.gz'
...
final_original = final_original.withColumn("outcome", when(final_original.postpartum == 1, 0).otherwise(1))
#final_original.show()
...
for i in range(1, 13):
    ...
    final_updated = final_updated.withColumn("outcome", when(final_updated.postpartum == 1, 0).otherwise(1))
