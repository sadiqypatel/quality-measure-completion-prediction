...
logged_model = 'runs:/e784c82df2064839860a59642d5d6da1/amm_contin.tar.gz'
...
final_original = final_original.withColumn("outcome", when(final_original.outcome2_yes == 1, 0).otherwise(1))
#final_original.show()
...
for i in range(1, 13):
    ...
    final_updated = final_updated.withColumn("outcome", when(final_updated.outcome2_yes == 1, 0).otherwise(1))
