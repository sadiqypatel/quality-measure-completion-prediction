...
logged_model = 'runs:/220c7ea5135547cab3dc162aca7d2540/pbd_model.tar.gz'
...
final_original = final_original.withColumn("outcome", when(final_original.outcome1_yes == 0, 1).otherwise(0))
#final_original.show()
...
for i in range(1, 13):
    ...
    final_updated = final_updated.withColumn("outcome", when(final_updated.outcome1_yes == 0, 1).otherwise(0))
