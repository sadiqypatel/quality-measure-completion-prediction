...
logged_model = 'runs:/4b401b5c93994608bfc0427bf4b9a803/amm_acute.tar.gz'
...
final_original = final_original.withColumn("outcome", when(final_original.outcome1_yes == 1, 0).otherwise(1))
#final_original.show()
...
for i in range(1, 13):
    ...
    final_updated = final_updated.withColumn("outcome", when(final_updated.outcome1_yes == 1, 0).otherwise(1))
