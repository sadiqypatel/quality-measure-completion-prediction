...
logged_model = 'runs:/9f8bd952f8dc46d3b62d0d8cecc0e33a/spc_adhered.tar.gz'
...
final_original = final_original.withColumn("outcome", when(final_original.adherence_yes == 1, 0).otherwise(1))
#final_original.show()
...
for i in range(1, 13):
    ...
    final_updated = final_updated.withColumn("outcome", when(final_updated.adherence_yes == 1, 0).otherwise(1))
