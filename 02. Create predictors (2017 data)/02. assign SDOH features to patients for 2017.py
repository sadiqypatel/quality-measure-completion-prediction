...
df = spark.table("dua_058828_spa240.paper_4_demo_file_01_12_months")
...
import pandas as pd
pandas_df = pd.read_sas("/Volumes/analytics/dua_058828_spa240/files/ahrq_sdoh_county_2020.sas7bdat")
pandas_df.head()
...
merged_df.write.saveAsTable("dua_058828_spa240.paper_4_sdoh_notebook_02_12_months", mode="overwrite")

# COMMAND ----------

df = spark.table("dua_058828_spa240.paper_4_sdoh_notebook_02_12_months")
print(df.count())
