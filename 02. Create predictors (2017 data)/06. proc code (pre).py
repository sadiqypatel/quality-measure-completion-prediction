...
import pandas as pd
betos_df = pd.read_csv("/Volumes/analytics/dua_058828_spa240/files/rbcsCrossWalk.csv")
#betos_df.head()
...
proc_code_predictor.write.saveAsTable("dua_058828_spa240.paper_4_proc_code_predictors_12_months", mode='overwrite') 
