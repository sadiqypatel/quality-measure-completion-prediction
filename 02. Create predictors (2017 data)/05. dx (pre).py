...
inpatient = spark.table("dua_058828_spa240.paper_4_inpatient2017_12_months_new")
...
import pandas as pd
ccsr_df = pd.read_csv("/Volumes/analytics/dua_058828_spa240/files/ccsrCategory.csv")
...
dx_predictor.write.saveAsTable("dua_058828_spa240.paper_4_dx_predictors_12_months", mode='overwrite') 