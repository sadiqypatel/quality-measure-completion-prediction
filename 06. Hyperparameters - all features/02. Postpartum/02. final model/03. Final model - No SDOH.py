...
value_counts = df.groupBy("postpartum").agg(count("postpartum").alias("count"))
...
df = df.withColumn("outcome", when(df.postpartum == 1, 0).otherwise(1))
...
params_list = [
    {"colsample_bylevel": 0.75, "colsample_bytree": 0.5, "gamma": 0, "learning_rate": 0.01, "max_depth": 24, "min_child_weight": 0, "reg_alpha": 0, "reg_lambda": 0, "subsample": 0.5}
]

# params_list = [
#     {"colsample_bylevel": 0.75, "colsample_bytree": 0.5, "gamma": 0, "learning_rate": 0.01, "max_depth": 24, "min_child_weight": 0, "reg_alpha": 0, "reg_lambda": 0, "subsample": 0.5},
#     {"colsample_bylevel": 0.75, "colsample_bytree": 0.5, "gamma": 0, "learning_rate": 0.01, "max_depth": 24, "min_child_weight": 0, "reg_alpha": 0.5, "reg_lambda": 0, "subsample": 0.5},
#     {"colsample_bylevel": 1, "colsample_bytree": 0.5, "gamma": 0, "learning_rate": 0.01, "max_depth": 24, "min_child_weight": 0, "reg_alpha": 0, "reg_lambda": 0, "subsample": 0.5},
#     {"colsample_bylevel": 0.75, "colsample_bytree": 0.5, "gamma": 0, "learning_rate": 0.01, "max_depth": 24, "min_child_weight": 0, "reg_alpha": 0, "reg_lambda": 0, "subsample": 0.5},
#     {"colsample_bylevel": 1, "colsample_bytree": 0.5, "gamma": 0, "learning_rate": 0.01, "max_depth": 24, "min_child_weight": 0, "reg_alpha": 0.5, "reg_lambda": 0, "subsample": 0.5}
# ]
...
experiment_name = "/Workspace/Users/spa240@ccwdata.org/Paper 4/06. Hyperparameters - all features/02. Postpartum/02. final model/Final model - postpartum - NO SDOH run 2"
...
best_train_predictions.write.saveAsTable("dua_058828_spa240.paper_4_postpartum_final_train_xgboost_no_sdoh", mode="overwrite")
best_test_predictions.write.saveAsTable("dua_058828_spa240.paper_4_postpartum_final_test_xgboost_no_sdoh", mode="overwrite")