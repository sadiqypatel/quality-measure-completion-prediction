...
param_grid = (
    ...
    .addGrid(xgb_classifier.reg_alpha, [0.0, 0.25, 0.5, 0.75, 1.0])                           
    .addGrid(xgb_classifier.reg_lambda, [0.0, 0.25, 0.5, 0.75, 1.0])                          
...
experiment_name = "/Workspace/Users/spa240@ccwdata.org/Paper 4/06. Hyperparameters - all features/13. Well child visits/WCV - 24 depth - 100k - run 1"
