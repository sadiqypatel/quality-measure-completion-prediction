...
outcome = spark.table("dua_058828_spa240.paper_4_well_child_visits_2018_12_months")
print(outcome.count())
outcome.show()
...
df = df.select("beneID","state","features","any_visit_2018")

# COMMAND ----------

# Perform value counts
value_counts = df.groupBy("any_visit_2018").agg(count("any_visit_2018").alias("count"))
...
df = df.withColumn("outcome", when(df.any_visit_2018 == 1, 0).otherwise(1))
...
params_list = [
    ...
    {"colsample_bylevel": 1, "colsample_bytree": 0.5, "gamma": 0.5, "learning_rate": 0.01, "max_depth": 24, "min_child_weight": 0, "reg_alpha": 0, "reg_lambda": 0.5, "subsample": 0.25},
]
...
experiment_name = "/Workspace/Users/spa240@ccwdata.org/Paper 4/06. Hyperparameters - all features/13. Well child visits/WCV - 24 depth - 100k - final model - no SDOH"
...
best_train_predictions.write.saveAsTable("dua_058828_spa240.paper_4_wcv_train_xgboost_new1_no_sdoh", mode="overwrite")
best_test_predictions.write.saveAsTable("dua_058828_spa240.paper_4_wcv_test_xgboost_new1_no_sdoh", mode="overwrite")