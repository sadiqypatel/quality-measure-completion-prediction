...
outcome = spark.table("dua_058828_spa240.paper_4_spc_both_outcomes_12_months_new4")
print(outcome.count())
outcome.show()
...
params_list = [
    ...
    {"colsample_bylevel": 1.0, "colsample_bytree": 0.5, "gamma": 0.0, "learning_rate": 0.01, "max_depth": 24, "min_child_weight": 0, "reg_alpha": 0, "reg_lambda": 0, "subsample": 0.25},
]
...
experiment_name = "/Workspace/Users/spa240@ccwdata.org/Paper 4/06. Hyperparameters - all features/10. SPC - statin adhered/SPC - Outcome 2 - 24 depth - final model no SDOH"
...
best_train_predictions.write.saveAsTable("dua_058828_spa240.paper_4_spc_outcome2_train_xgboost_new1_no_sdoh", mode="overwrite")
best_test_predictions.write.saveAsTable("dua_058828_spa240.paper_4_spc_outcome2_test_xgboost_new1_no_sdoh", mode="overwrite")