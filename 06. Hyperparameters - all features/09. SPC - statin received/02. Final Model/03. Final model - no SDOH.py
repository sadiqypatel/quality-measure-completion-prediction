...
outcome = spark.table("dua_058828_spa240.paper_4_spc_outcome1_12_months_new2")
print(outcome.count())
outcome.show()
...
experiment_name = "/Workspace/Users/spa240@ccwdata.org/Paper 4/06. Hyperparameters - all features/09. SPC - statin received/Final model - SPC Outcome 1 - No SDOH - run 1"
...
best_train_predictions.write.saveAsTable("dua_058828_spa240.paper_4_spc_outcome1_train_xgboost_new1_no_sdoh", mode="overwrite")
best_test_predictions.write.saveAsTable("dua_058828_spa240.paper_4_spc_outcome1_test_xgboost_new1_no_sdoh", mode="overwrite")