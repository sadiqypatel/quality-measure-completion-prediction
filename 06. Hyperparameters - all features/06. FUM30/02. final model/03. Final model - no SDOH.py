...
outcome = spark.table("dua_058828_spa240.paper_4_fum30_outcome_12_months_new2")
print(outcome.count())
outcome.show()

# COMMAND ----------

vector = spark.table("dua_058828_spa240.paper4_demo_clinical_vector")
print(vector.count())
vector.show()
...
df = df.select("beneID","state","features","bh_visit")

# COMMAND ----------

# Perform value counts
value_counts = df.groupBy("bh_visit").agg(count("bh_visit").alias("count"))
...
df = df.withColumn("outcome", when(df.bh_visit == 1, 0).otherwise(1))
...
# params_list = [
#     {"colsample_bylevel": 1, "colsample_bytree": 0.5, "gamma": 0.01, "learning_rate": 0.01, "max_depth": 22, "min_child_weight": 0, "reg_alpha": 0, "reg_lambda": 0, "subsample": 0.25},
#     {"colsample_bylevel": 0.25, "colsample_bytree": 0.5, "gamma": 0.01, "learning_rate": 0.01, "max_depth": 22, "min_child_weight": 0, "reg_alpha": 0, "reg_lambda": 0, "subsample": 0.25},
#     {"colsample_bylevel": 0.75, "colsample_bytree": 0.5, "gamma": 0.01, "learning_rate": 0.01, "max_depth": 22, "min_child_weight": 0, "reg_alpha": 0, "reg_lambda": 0, "subsample": 0.25},
#     {"colsample_bylevel": 0.25, "colsample_bytree": 0.5, "gamma": 0.01, "learning_rate": 0.01, "max_depth": 22, "min_child_weight": 0.25, "reg_alpha": 0, "reg_lambda": 0, "subsample": 0.25},
#     {"colsample_bylevel": 0.5, "colsample_bytree": 0.5, "gamma": 0.01, "learning_rate": 0.01, "max_depth": 24, "min_child_weight": 0, "reg_alpha": 0, "reg_lambda": 0, "subsample": 0.25},
#     {"colsample_bylevel": 0.75, "colsample_bytree": 0.5, "gamma": 0.01, "learning_rate": 0.01, "max_depth": 24, "min_child_weight": 0, "reg_alpha": 0, "reg_lambda": 0, "subsample": 0.25}
# ]

params_list = [
    {"colsample_bylevel": 0.25, "colsample_bytree": 0.5, "gamma": 0.0, "learning_rate": 0.01, "max_depth": 24, "min_child_weight": 0, "reg_alpha": 0, "reg_lambda": 0, "subsample": 0.25}
]
...
experiment_name = "/Workspace/Users/spa240@ccwdata.org/Paper 4/06. Hyperparameters - all features/06. FUM30/02. final model/Final model - fum30 no SDOH - run 1 50 percent"
...
best_train_predictions.write.saveAsTable("dua_058828_spa240.paper_4_fum30_train_xgboost_new1_no_sdoh", mode="overwrite")
best_test_predictions.write.saveAsTable("dua_058828_spa240.paper_4_fum30_test_xgboost_new1_no_sdoh", mode="overwrite")