...
params_list = [
    ...
    {"colsample_bylevel": 0.5, "colsample_bytree": 0.5, "gamma": 0, "learning_rate": 0.01, "max_depth": 24, "min_child_weight": 0, "reg_alpha": 0, "reg_lambda": 0, "subsample": 0.25},
...
experiment_name = "/Workspace/Users/spa240@ccwdata.org/Paper 4/06. Hyperparameters - all features/07. AMM - Acute Phase/02. final model/Final model - AMM Contin- run 4"
...
best_train_predictions.write.saveAsTable("dua_058828_spa240.paper_4_amm_contin_train_xgboost_new3", mode="overwrite")
best_test_predictions.write.saveAsTable("dua_058828_spa240.paper_4_amm_contin_test_xgboost_new3", mode="overwrite")