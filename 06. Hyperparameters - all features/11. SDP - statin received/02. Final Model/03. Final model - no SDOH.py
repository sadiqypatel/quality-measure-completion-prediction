...
experiment_name = "/Workspace/Users/spa240@ccwdata.org/Paper 4/06. Hyperparameters - all features/11. SDP - statin received/02. Final Model/Final model - SPD Outcome 1 - 100k - no SDOH - run 1"
...
best_train_predictions.write.saveAsTable("dua_058828_spa240.paper_4_spd_outcome1_train_xgboost_new1_no_sdoh", mode="overwrite")
best_test_predictions.write.saveAsTable("dua_058828_spa240.paper_4_spd_outcome1_test_xgboost_new1_no_sdoh", mode="overwrite")