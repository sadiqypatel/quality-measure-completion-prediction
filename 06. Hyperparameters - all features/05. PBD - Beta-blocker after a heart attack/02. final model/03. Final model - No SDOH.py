...
outcome = spark.table("dua_058828_spa240.paper_4_pbh_with_outcomes_new1")
print(outcome.count())
outcome.show()
...
df = df.withColumn("outcome", when(df.outcome1_yes == 0, 1).otherwise(0))
...
params_list = [
    {"colsample_bylevel": 0.25, "colsample_bytree": 0.5, "gamma": 0.01, "learning_rate": 0.01, "max_depth": 24, "min_child_weight": 0, "reg_alpha": 0, "reg_lambda": 0, "subsample": 0.25}
]
...
experiment_name = "/Workspace/Users/spa240@ccwdata.org/Paper 4/06. Hyperparameters - all features/05. PBD - Beta-blocker after a heart attack/02. final model/Final model - pbd -no sdoh"
...
best_train_predictions.write.saveAsTable("dua_058828_spa240.paper_4_pbh_train_xgboost_new1_no_sdoh", mode="overwrite")
best_test_predictions.write.saveAsTable("dua_058828_spa240.paper_4_pbh_test_xgboost_new1_no_sdoh", mode="overwrite")