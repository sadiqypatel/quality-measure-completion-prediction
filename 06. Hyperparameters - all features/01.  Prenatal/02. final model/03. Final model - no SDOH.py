...
value_counts = df.groupBy("prenatal").agg(count("prenatal").alias("count"))
...
df = df.withColumn("outcome", when(df.prenatal == 1, 0).otherwise(1))
...
params_list = [ {"colsample_bylevel": 0.5, "colsample_bytree": 0.5, "gamma": 0, "learning_rate": 0.01, "max_depth": 24, "min_child_weight": 0, "reg_alpha": 0, "reg_lambda": 0, "subsample": 0.5}]
...
experiment_name = "/Workspace/Users/spa240@ccwdata.org/Paper 4/06. Hyperparameters - all features/01.  Prenatal/02. final model/Final model - prenatal - no sdoh"
...
best_train_predictions.write.saveAsTable("dua_058828_spa240.paper_4_prenatal_final_train_xgboost_no_SDOH", mode="overwrite")
best_test_predictions.write.saveAsTable("dua_058828_spa240.paper_4_prenatal_final_test_xgboost_no_SDOH", mode="overwrite")