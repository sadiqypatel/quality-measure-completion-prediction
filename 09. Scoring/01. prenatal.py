...
logged_model = 'runs:/96968b80c8e34aa58c22fbf13aa2ab93/prenatal_model_new1.tar.gz'
...
final_original = final_original.withColumn("outcome", when(final_original.prenatal == 1, 0).otherwise(1))
#final_original.show()
...
for i in range(1, 14):
    ...
    final_updated = final_updated.withColumn("outcome", when(final_updated.prenatal == 1, 0).otherwise(1))
...
df_1 .write.saveAsTable("dua_058828_spa240.test_with_parth", mode='overwrite')

# COMMAND ----------

df_1 = spark.table("dua_058828_spa240.test_with_parth")
