...
denom = spark.table("dua_058828_spa240.paper_4_spc_outcome1_12_months_new2")
print(denom.count())
denom.show()
...
# Aggregate the data
aggregated_df = numerator.groupBy('beneID', 'state', 'NDC').agg(
...
final_filtered = final.select("beneID","state","total_value", "anymed",'adherance',"adherence_yes")
final_filtered.show()

# COMMAND ----------

# MAGIC %md
# MAGIC save final file

# COMMAND ----------

final_filtered.write.saveAsTable("dua_058828_spa240.paper_4_spc_both_outcomes_12_months_new4", mode='overwrite')
