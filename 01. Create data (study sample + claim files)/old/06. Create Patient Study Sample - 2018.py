...
member = spark.table("dua_058828_spa240.elig2018")
member.show()
...
dfNew.write.saveAsTable("dua_058828_spa240.paper4_final_sample_plan_28_2018", mode='overwrite')

# COMMAND ----------

# MAGIC %md
# MAGIC this code needs to be updated w/ correct count list for 2017 to work.

# COMMAND ----------

county_data = spark.table("dua_058828_spa240.paper4_final_sample_plan_28_2018")
county_data.show()
...
df_with_fips.write.saveAsTable("dua_058828_spa240.paper4_final_sample_plan_28_2018", mode='overwrite')

# COMMAND ----------

# MAGIC %md
# MAGIC RUN THIS FOR 8 or MORE MONTHS

# COMMAND ----------

df = spark.table("dua_058828_spa240.paper4_final_sample_plan_28_2018")
...
df.write.saveAsTable("dua_058828_spa240.paper4_final_sample_plan_28_8_or_more_2018", mode='overwrite')

# COMMAND ----------

df = spark.table("dua_058828_spa240.paper4_final_sample_plan_28_8_or_more_2018")
df.show()
