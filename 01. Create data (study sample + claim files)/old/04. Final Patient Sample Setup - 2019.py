...
df = spark.table("dua_058828_spa240.paper4_final_sample_from_notebook_03")
df.show()
...
plan = spark.table("dua_058828_spa240.paper4_final_state_plans_28")
plan.show()
...
filtered_df.write.saveAsTable("dua_058828_spa240.paper4_final_sample_from_notebook_04_new", mode='overwrite')

# COMMAND ----------

df = spark.table("dua_058828_spa240.paper4_final_sample_from_notebook_04_new")
df.show()
