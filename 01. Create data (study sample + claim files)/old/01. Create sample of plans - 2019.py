...
df = spark.table("dua_058828_spa240.paper4_final_sample")
...
plan = spark.sql("select MC_PLAN_ID, MC_PLAN_NAME, STATE_CD, MC_PLAN_TYPE_CTGRY_CD, MC_PLAN_REIMBRSMT_TYPE_CD, MC_PLAN_REIMBRSMT_TYPE_CTGRY_CD, MC_ENT_PRFT_STUS_CD, OPRTG_AUTHRTY_1115_DEMO_WVR_IND from extracts.tafan19.mngd_care_plan_base")
plan.show()
...
columns_to_check = ["MC_PLAN_REIMBRSMT_TYPE_CD", "MC_PLAN_REIMBRSMT_TYPE_CTGRY_CD", "MC_ENT_PRFT_STUS_CD", "OPRTG_AUTHRTY_1115_DEMO_WVR_IND"]  # Replace these with your actual column names
...
plan_final.write.saveAsTable("dua_058828_spa240.paper4_final_state_plans_2019_28_nb1", mode='overwrite')

# COMMAND ----------

df = spark.table("dua_058828_spa240.paper4_final_state_plans_2019_28_nb1")
df.show()
